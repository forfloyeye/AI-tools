        ...
        >
          ...
          <div className="flex border-b border-slate-100">
            <button
              className={cn(
                ...
                tab === 'login' ? "text-indigo-600 border-b-2 border-indigo-600" : "text-slate-500 hover:text-slate-700"
              )}
            ...
            <button
              className={cn(
                "flex-1 py-4 text-sm font-medium transition-colors",
                tab === 'register' ? "text-indigo-600 border-b-2 border-indigo-600" : "text-slate-500 hover:text-slate-700"
              )}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="relative w-full rounded-xl bg-slate-900 py-3 text-sm font-medium text-white transition-all hover:bg-slate-800 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 flex items-center justify-center"
            >
              {isLoading ? (
                <>
